...
const addUser = async (args, transporter) => {
    ...
    const text = (
`Welcome to DSA2023, This email is just to inform you that your DSA Judge account is created.
Here are your account and password.

- Account: ${args.user}
- Password: ${randPass}

Head on to https://dsa2023.csie.org to try it !
` );
...
Head on to https://dsa2023.csie.org and change it.
` );

    const mailOptions = {
        from: '"DSA2023" <dsa_ta@csie.ntu.edu.tw>',
        to: args.user,
        subject: `[DSA2023]Password of your DSA Judge Account has been reset`,
        text,
    };
