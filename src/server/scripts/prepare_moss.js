...
const parser = new Parser({
  description: 'Copy submissions of problem id y in homework id x (exclude admin & TA) before deadline to /home/das-2025/DSA-judge/moss/x_y/'
});
...
(async () => {
  ...
  const folder = `/home/dsa-2025/DSA-judge/moss/${args.homework_id}_${args.problem_id}`;
